      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          <p className="text-pink-500 text-start font-semibold uppercase mb-2">
            About Prefer Coding Secret's
          </p>
          <h2
            className="text-3xl md:text-5xl text-start font-bold leading-relaxed mb-4"
            style={{ lineHeight: "115%" }}
          >
            Empowering Young Minds through <br /> Web Development
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="font-bold text-xl mb-2 text-start">Live Projects</h3>
            {/*<p className="text-gray-600 text-start">
              Tellus tristique habitant non orci ante ipsum quis. Donec etiam
              hac in ultrices sed dictumst.
            </p>*/}
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="font-bold text-xl mb-2 text-start">Job Assistance</h3>
            {/* <p className="text-gray-600 text-start">
              Tellus tristique habitant non orci ante ipsum quis. Donec etiam
              hac in ultrices sed dictumst.
            </p>*/}
